...
export default function Chart() {
	const { budget, categories, expenses } = useContext(AppContext);
	const CHART_COLORS = [
		"rgba(255, 99, 132, 0.4)",
		"rgba(5, 76, 205, 0.4)",
		"rgba(255, 206, 86, 0.4)",
	...
	const [dataChart, setDataChart] = useState({
		labels: getDataBy(getUniqueList(data), "category"),
		datasets: [
			{
	...
	return (
		<div className="chart flex-1">
			<h1 className={H1 + " mb-3"}>Stats</h1>
			<div className="mx-auto" style={{ width: "20vw" }}>
				<Doughnut
					data={dataChart}
